...
class Face_Recognition_System:
    def __init__(self, root):
        ...
        lbl.place(x=0,y=0,width=118,height=50)
        time()
        ...
        btn2_2 = Button(bg_img, text="Face Detector", cursor="hand2",command=self.face_recognition, font=("times new roman", 15, "bold"),
                        bg="darkblue", fg="white")
        ...
        btn3 = Button(bg_img, image=self.photoimg7, cursor="hand2",command=self.attendance)
        btn3.place(x=700, y=80, width=195, height=195)

        btn3_3 = Button(bg_img, text="Attendance", cursor="hand2",command=self.attendance, font=("times new roman", 15, "bold"),
                        bg="darkblue", fg="white")
        ...
        btn4 = Button(bg_img, image=self.photoimg8, cursor="hand2",command=self.help)
        btn4.place(x=1000, y=80, width=195, height=195)

        btn4_4 = Button(bg_img, text="Help Desk", cursor="hand2",command=self.help, font=("times new roman", 15, "bold"),
                        bg="darkblue", fg="white")
        ...
        btn5 = Button(bg_img, image=self.photoimg9, cursor="hand2",command=self.train)
        btn5.place(x=100, y=350, width=195, height=195)

        btn5_5 = Button(bg_img, text="Train Data", cursor="hand2",command=self.train, font=("times new roman", 15, "bold"),
                        bg="darkblue", fg="white")
