...
class login_window:
    def __init__(self, root):
        ...
        self.txtpass = ttk.Entry(frame,textvariable=self.var_pass, show="*",font=("times new roman", 15, "bold"))
        ...
        registerbtn = Button(frame, text="New User Register", command=self.register_window, font=(
            "times new roman", 10, "bold"), borderwidth=0, bg="green", fg="orange",activebackground="green",activeforeground="orange")
        registerbtn.place(x=15, y=350, width=160)

        # forgetpasswordButton
        forgetbtn = Button(frame, text="Forget Password", command=self.forgot_password_window,font=("times new roman", 10, "bold"), borderwidth=0, bg="green", fg="orange", activebackground="green",activeforeground="orange")
    ...
    def login(self):
        ...
        elif self.txtuser.get() == "user" and self.txtpass.get() == "user@123":
            speak_va("Welcome to Face Recognition World")
            messagebox.showinfo("success", "welcome to Face Recognition World")
            self.new_window=Toplevel(self.root)
            self.app=Face_Recognition_System(self.new_window)
        else:
            conn = mysql.connector.connect(host="localhost", user="root", password="shruti0603", database="face_recognizer")
